const authPageImage = (
    ...
    >
        <defs>
            <style
                dangerouslySetInnerHTML={{
                    __html: '.a{opacity:0.8;}.b{fill:url(#a);}.c,.e{fill:#3f9142;}.d,.h{fill:#fff;}.d,.m{opacity:0.1;}.e,.i{opacity:0.2;}.f{opacity:0.3;}.g{fill:url(#b);}.j{fill:#e0e0e0;}.k,.o,.q{opacity:0.5;}.l{fill:url(#c);}.n{opacity:0.05;}.o{fill:#4d8af0;}.p{fill:#47e6b1;}.q{fill:#f55f44;}',
                }}
            />
            ...
            <linearGradient id='b' x1='-0.512' y1='7.758' x2='-0.512' y2='6.717' xlinkHref='#a' />
            <linearGradient id='c' x1='-1.386' y1='7.85' x2='-1.386' y2='6.809' xlinkHref='#a' />
        </defs>
        <g className='a' transform='translate(98.3 6.928)'>
            <ellipse className='b' cx='53.831' cy='41.702' rx='53.831' ry='41.702' />
        </g>
        <ellipse
            className='c'
            cx='52.636'
        ...
        />
        <g className='f' transform='translate(119.12 161.253)'>
            <path
                className='g'
        ...
        <g className='a' transform='translate(42.181 37.956)'>
            <ellipse className='b' cx='106.36' cy='28.452' rx='106.36' ry='28.452' />
        </g>
        <path
            className='h'
        ...
        <g className='k' transform='translate(37.857 93.627)'>
            <rect className='p' width='1.103' height='6.248' transform='translate(2.573)' />
            <rect
                className='p'
                width='1.103'
                height='6.248'
        ...
        />
        <circle className='q' cx='2.205' cy='2.205' r='2.205' transform='translate(0 2.517)' />
        <circle
            className='q'
            cx='2.205'
            cy='2.205'
